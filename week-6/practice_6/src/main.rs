fn main() {
    ...
    println!("\nThe {} is informed by the aspiration to train electrical/electronic engineering professionals in the mareas of desin, building and maintenance of electrical control systems", n4);
